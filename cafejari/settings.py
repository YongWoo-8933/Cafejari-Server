...
# cronjab 설정
CRONJOBS = [
    ('*/30 0-14 * * *', 'cron.congestion.update_congestion_area_cron'), # 매일 9-23시동안 30분마다 업데이트
    ...
    ('35 10 * * *', 'cron.cafe_vip.update_cafe_vip'), # 매일 자정 30분에 업데이트
    ('35 10 * * *', 'cron.leaderboard.update_leaders'), # 매일 자정 30분에 업데이트
]
